...
abstract class VQMod {
	...
	public static $logFolder = 'system/vendor/vqmod/logs/';
	public static $vqCachePath = 'system/vendor/vqmod/vqcache/';
	public static $modCache = 'system/vendor/vqmod/mods.cache';
	public static $protectedFilelist = 'system/vendor/vqmod/vqprotect.txt';
	public static $pathReplaces = 'system/vendor/vqmod/pathReplaces.php';
        public static $vqPath = 'system/vendor/';
	...
	private static function _getMods() {
		...
		self::$_modFileList = glob(self::path(self::$vqPath . 'vqmod/xml/', true) . '*.xml');
		...
		$xml_folder_time = filemtime(self::path(self::$vqPath . 'vqmod/xml'));

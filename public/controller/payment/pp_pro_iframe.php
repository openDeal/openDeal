...
class ControllerPaymentPPProIframe extends \Core\Controller {
    ...
    protected function index() {
        ...
        $this->template = 'payment/pp_pro_iframe.phtml';
    ...
    public function create() {
        ...
        if (file_exists(DIR_APPLICATION . 'view/theme/' . $this->config->get('config_template') . '/stylesheet/stylesheet.css')) {
            $this->data['stylesheet'] = '/public/view/theme/' . $this->config->get('config_template') . '/stylesheet/stylesheet.css';
        } else {
            $this->data['stylesheet'] = '/public/view/theme/default/stylesheet/stylesheet.css';
        }


        $this->template = 'payment/pp_pro_iframe_body.phtml';
    ...
    private function constructButtonData($order_info) {
        ...
        $s_data['BUTTONSOURCE'] = 'OpenDeal_Cart_WPP';
        ...
        $this->model_payment_pp_pro_iframe->log(print_r($s_data, 1));

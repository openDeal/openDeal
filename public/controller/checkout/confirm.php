...
class ControllerCheckoutConfirm extends \Core\Controller {
    ...
    public function index() {
        ...
        if (!$redirect) {
            ...
            foreach ($this->cart->getProducts() as $product) {
                ...
                $product['href'] = $this->url->link('deal/deal', 'deal_id=' . $product['deal_id']);
        ...
        $this->template = 'checkout/confirm.phtml';

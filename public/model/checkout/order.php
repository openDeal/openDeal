...
class ModelCheckoutOrder extends \Core\Model {

    public function addOrder($data) {
        $this->db->query("INSERT INTO `#__order` SET "
        ...
        foreach ($data['products'] as $product) {
            $is_collect = ($product['is_coupon'] == 0 && $product['shipping']['deal_shipping_id'] == 0) ? '1' : '0';
            $this->db->query("INSERT INTO #__order_deal SET order_id = '" . (int) $order_id . "', "
                    . "deal_id = '" . (int) $product['deal_id'] . "', "
                    . "title = '" . $this->db->escape($product['title']) . "', "
                    . "quantity = '" . (int) $product['quantity'] . "', "
                    . "price = '" . (float) $product['price'] . "', "
                    . "total = '" . (float) $product['total'] . "', "
                    . "is_coupon = '" . (int) $product['is_coupon'] . "', "
                    . "is_collect = " . (int) $is_collect);
        ...
        foreach ($data['vouchers'] as $voucher) {
            $this->db->query("INSERT INTO #__order_voucher SET order_id = '" . (int) $order_id . "', description = '" . $this->db->escape($voucher['description']) . "', code = '" . $this->db->escape($voucher['code']) . "', from_name = '" . $this->db->escape($voucher['from_name']) . "', from_email = '" . $this->db->escape($voucher['from_email']) . "', to_name = '" . $this->db->escape($voucher['to_name']) . "', to_email = '" . $this->db->escape($voucher['to_email']) . "', voucher_theme_id = '" . (int) $voucher['voucher_theme_id'] . "', message = '" . $this->db->escape($voucher['message']) . "', amount = '" . (float) $voucher['amount'] . "'");
        }

        foreach ($data['totals'] as $total) {
            $this->db->query("INSERT INTO #__order_total SET order_id = '" . (int) $order_id . "', code = '" . $this->db->escape($total['code']) . "', title = '" . $this->db->escape($total['title']) . "', text = '" . $this->db->escape($total['text']) . "', `value` = '" . (float) $total['value'] . "', sort_order = '" . (int) $total['sort_order'] . "'");
        }
    ...
    public function getOrder($order_id) {
        $order_query = $this->db->query("SELECT *, "
                . "(SELECT os.name FROM `#__order_status` os WHERE os.order_status_id = o.order_status_id AND "
                . "os.language_id = o.language_id) AS order_status FROM `#__order` o "
    ...
    public function confirm($order_id, $order_status_id, $comment = '', $notify = false) {
        ...
        if ($order_info && !$order_info['order_status_id']) {
            ...
            $order_voucher_query = $this->db->query("SELECT * FROM #__order_voucher WHERE order_id = '" . (int) $order_id . "'");
            ...
            foreach ($order_voucher_query->rows as $order_voucher) {
                ...
                $this->db->query("UPDATE #__order_voucher SET voucher_id = '" . (int) $voucher_id . "' WHERE order_voucher_id = '" . (int) $order_voucher['order_voucher_id'] . "'");
            }
    ...
    public function update($order_id, $order_status_id, $comment = '', $notify = false) {
        ...
        if ($order_info && $order_info['order_status_id']) {
            ...
            $this->db->query("INSERT INTO #__order_history SET order_id = '" . (int) $order_id . "', order_status_id = '" . (int) $order_status_id . "', notify = '" . (int) $notify . "', comment = '" . $this->db->escape($comment) . "', date_added = NOW()");

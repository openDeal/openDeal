...
class ControllerCommonHeader extends \Core\Controller {
    ...
    protected function index() {
        ...
        $this->data['text_report_freepon_viewed'] = $this->language->get('text_report_freepon_viewed');
        ...
        if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
            ...
            $this->data['home'] = $this->url->link('user/login', '', 'SSL');
            $this->template = "common/alt-header.phtml";
        } else {
            ...
            $this->data['report_freepon_viewed'] = $this->url->link('report/freepon_viewed', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['link_company'] = $this->url->link('deal/company', 'token=' . $this->session->data['token'], 'SSL');

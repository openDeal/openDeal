...
class ControllerSettingLanguage extends \Core\Controller {
    ...
    public function index() {
        ...
        //Loads language
        $this->load->language('setting/language');
        //Loads model
        ...
        $edit_lang = $this->model_setting_language->getLanguage($def_lang_id);
        ...
        $this->data['action_select'] = $this->url->link('setting/language', 'token=' . $this->session->data['token'] . $file_param_pass);
        $this->data['file_link'] = $this->url->link('setting/language', 'token=' . $this->session->data['token'] . $link_param_section . "&name_language=" . $edit_lang . "&file=");
        $this->data['action_edit'] = $this->url->link('setting/language', 'token=' . $this->session->data['token'] . $link_param_section . "&name_language=" . $edit_lang . "&file=" . $edit_file . "&string=");
        $this->data['viewing_file_link'] = $this->url->link('setting/language', 'token=' . $this->session->data['token'] . $link_param_section . "&name_language=" . $edit_lang . "&file=" . $edit_file);
        ...
        $this->data['breadcrumbs'][] = array(
            'href' => $this->url->link('setting/language', 'token=' . $this->session->data['token']),
            'text' => $this->language->get('heading_title'),
            'separator' => '  ::  '
        );

        $this->template = 'setting/language.phtml';
        $this->children = array(
            'common/header',
            'common/footer'
        );

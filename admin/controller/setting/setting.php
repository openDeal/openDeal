...
class ControllerSettingSetting extends \Core\Controller {
    ...
    public function index() {
        ...
        $this->data['entry_catalog_limit_help'] = $this->language->get('entry_catalog_limit_help');
        $this->data['entry_admin_limit_help'] = $this->language->get('entry_admin_limit_help');
        ...
        if (isset($this->request->post['config_gttimezone'])) {
            $this->data['config_gttimezone'] = $this->request->post['config_gttimezone'];
        } else {
            $this->data['config_gttimezone'] = $this->config->get('config_gttimezone');
        }
        $this->data['gttzlist'] = DateTimeZone::listIdentifiers(DateTimeZone::ALL);
        ...
        if (isset($this->request->post['config_city_id'])) {
            $this->data['config_city_id'] = $this->request->post['config_city_id'];
        } else {
            $this->data['config_city_id'] = $this->config->get('config_city_id');
        }

...
$_['button_clear'] = 'Clear Cached Files';
$_['button_download_log'] = 'Download Log';
$_['button_vqcache_dump'] = 'Download Cached Files';

// Heading
$_['heading_title'] = 'Plugin Manager';
...
$_['error_vqmod_opendeal'] = 'Warning: \'vqmod_opendeal.xml\' is rquired for VQMod to function properly!';
...
$_['error_opendeal_version'] = 'OpenDeal 1.0.x or later is required to use VQMod Manager!';
$_['error_opendeal_xml'] = 'Required file "<span class="error-install">/vqmod/xml/vqmod_opendeal.xml</span>" does not appear to exist!  Please install the latest OpenDeal-compatible version of VQMod from <a href="http://code.google.com/p/vqmod/" target="_blank">http://code.google.com/p/vqmod/</a> and try again.';
$_['error_opendeal_xml_disabled'] = 'Warning: "<span class="error-install">vqmod_opendeal.xml</span>" is disabled!  Plugin scripts will not function!';
$_['error_opendeal_xml_version'] = 'You appear to be using a version of "<span class="error-install">vqmod_opendeal.xml</span>" that is out-of-date for your OpenDeal version!  Please install the latest OpenDeal-compatible version of VQMod from <a href="http://code.google.com/p/vqmod/" target="_blank">http://code.google.com/p/vqmod/</a> and try again.';
$_['error_vqcache_dir'] = 'Required directory "<span class="error-install">/vqmod/vqcache</span>" does not appear to exist!  Please install the latest OpenDeal-compatible version of VQMod from <a href="http://code.google.com/p/vqmod/" target="_blank">http://code.google.com/p/vqmod/</a> and try again.';
...
$_['error_vqmod_core'] = 'Required file "<span class="error-install">vqmod.php</span>" is missing!  Please install the latest OpenDeal-compatible version of VQMod from <a href="http://code.google.com/p/vqmod/" target="_blank">http://code.google.com/p/vqmod/</a> and try again.';
$_['error_vqmod_dir'] = 'The "<span class="error-install">/vqmod</span>" directory does not appear to exist!';
$_['error_vqmod_install_link'] = 'VQMod does not appear to have been integrated with OpenDeal!  Please run the VQMod installer at <a href="%1$s">%1$s</a>.  If you have previously run the installer ensure that you are using the latest version of VQMod found at <a href="http://code.google.com/p/vqmod/" target="_blank">http://code.google.com/p/vqmod/</a>.';
$_['error_vqmod_opendeal_integration'] = 'VQMod does not appear to have been integrated with OpenDeal!  Please install the latest OpenDeal-compatible version of VQMod from <a href="http://code.google.com/p/vqmod/" target="_blank">http://code.google.com/p/vqmod/</a> and try again.';
$_['error_vqmod_script_dir'] = 'Required directory "<span class="error-install">/vqmod/xml</span>" does not appear to exist!  Please install the latest OpenDeal-compatible version of VQMod from <a href="http://code.google.com/p/vqmod/" target="_blank">http://code.google.com/p/vqmod/</a> and try again.';
...
// Javascript Warnings
$_['warning_required_delete'] = 'WARNING: Deleting \\\'vqmod_opendeal.xml\\\' will cause VQMod to STOP WORKING!  Continue?';
$_['warning_required_uninstall'] = 'WARNING: Uninstalling \\\'vqmod_opendeal.xml\\\' will cause VQMod to STOP WORKING!  Continue?';

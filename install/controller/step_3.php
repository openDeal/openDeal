...
class ControllerStep3 extends \Core\Controller {
    ...
    public function index() {
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $output = '<?php' . "\n";
            $output .= "//@autoGeneratred Config \n";
            $output .= 'define(\'DIR_ROOT\',  dirname(dirname(__DIR__)) . \'/\');' . "\n";
            $output .= '// HTTP' . "\n";
            $output .= 'define(\'HTTP_CATALOG\', \'' . HTTP_OPENDEAL . '\');' . "\n";
            $output .= 'define(\'HTTPS_CATALOG\', \'' . HTTP_OPENDEAL . '\');' . "\n\n";
            $output .= '// DIR' . "\n";
            $output .= 'define(\'DIR_APPLICATION\', DIR_ROOT . APP_NAMESPACE . \'/\');' . "\n\n";
            ...
            $output .= 'define(\'DIR_ADMIN\', DIR_ROOT . \'admin/\');' . "\n\n";

            $output .= 'if (APP_NAMESPACE == \'public\') {' . "\n";
            $output .= 'define(\'HTTP_SERVER\', HTTP_CATALOG);' . "\n";
            $output .= 'define(\'HTTPS_SERVER\', HTTPS_CATALOG);' . "\n";
            $output .= '}else{' . "\n";
            $output .= ' define(\'HTTP_SERVER\', HTTP_CATALOG . APP_NAMESPACE . \'/\');' . "\n";
            $output .= ' define(\'HTTPS_SERVER\', HTTPS_CATALOG . APP_NAMESPACE . \'/\');' . "\n";
            $output .= '}' . "\n\n";
